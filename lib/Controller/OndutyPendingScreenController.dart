...
class OnDutyPendingScreenController extends GetxController {
  ...
  void play() {
    audioPlayer.setUrl("${ApiUrl.baseUrl}ideas/${userDataProvider
        .getOndDutyPendingData!.audioFile}");
    audioPlayer.play();
  ...
  Future<void> updateOnDuty() async {
    Map<String, dynamic> payload = {
      'Id': userDataProvider.getOndDutyPendingData!.id.toString(),
      ...
      'endingDate': "",
      'remarks': "",
      'ondutyStatus': userDataProvider.currentStatus == "Approve" ? "Approve" : "Reject",
    };
