class CommercialFromTechnicalList {
  String? message;
  bool? error;
  List<CommercialFromTechnicalData>? data;

  CommercialFromTechnicalList({this.message, this.error, this.data});

  CommercialFromTechnicalList.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    error = json['error'];
    if (json['data'] != null) {
      data = <CommercialFromTechnicalData>[];
      json['data'].forEach((v) {
        data!.add(new CommercialFromTechnicalData.fromJson(v));
      });
    }
  }
...
class CommercialFromTechnicalData {
  bool? error;
  int? projectId;
  String? customerName;
  String? mobileNum;
  ...
  int? factoryStatus;
  Null? commercialUpload;
  Null? technicalUpload;
  Null? process;
  List<FactoryProjectsItems>? factoryProjectsItems;

  CommercialFromTechnicalData(
      {this.projectId,
        this.customerName,
        this.mobileNum,
        this.email,
  ...
  CommercialFromTechnicalData.fromJson(Map<String, dynamic> json) {
