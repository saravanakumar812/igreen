class GetCommercialFromTechnicalResponse {
  String? message;
  bool? error;
  List<GetCommercialFromTechnicalResponseData>? data;

  GetCommercialFromTechnicalResponse({this.message, this.error, this.data});

  GetCommercialFromTechnicalResponse.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    error = json['error'];
    if (json['data'] != null) {
      data = <GetCommercialFromTechnicalResponseData>[];
      json['data'].forEach((v) {
        data!.add(new GetCommercialFromTechnicalResponseData.fromJson(v));
      });
    }
  }
...
class GetCommercialFromTechnicalResponseData {
  int? projectId;
  String? customerName;
  String? mobileNum;
  String? email;
  ...
  GetCommercialFromTechnicalResponseData.fromJson(Map<String, dynamic> json) {
