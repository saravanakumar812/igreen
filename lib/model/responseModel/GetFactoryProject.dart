class GetFactoryProjectResponse {
  String? message;
  bool? error;
  List<GetFactoryProjectData>? data;

  GetFactoryProjectResponse({this.message, this.error, this.data});

  GetFactoryProjectResponse.fromJson(Map<String, dynamic> json) {
    message = json['message'];
    error = json['error'];
    if (json['data'] != null) {
      data = <GetFactoryProjectData>[];
      json['data'].forEach((v) {
        data!.add(new GetFactoryProjectData.fromJson(v));
      });
    }
  }
