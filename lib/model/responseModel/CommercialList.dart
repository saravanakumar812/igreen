class CommercialList {
  String? message;
  bool? error;
  List<CommercialData>? data;

  CommercialList({this.message, this.error, this.data});

  CommercialList.fromJson(Map<String, dynamic> json) {
...
class CommercialData {
  ...
  String? process;
  List<dynamic>? factoryProjectsItems;
  ...
  CommercialData.fromJson(Map<String, dynamic> json) {
    ...
    //   factoryProjectsItems = <dynamic>[];
    //   json['FactoryProjectsItems'].forEach((v) {
    //     factoryProjectsItems!.add( Null.fromJson(v));
    //   });
    // }
  }
