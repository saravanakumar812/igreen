...
class EscalationResponseList
    extends GetView<EscalationResponseScreenController> {
  const EscalationResponseList({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    EscalationResponseScreenController controller =
        Get.put(EscalationResponseScreenController());
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                            // "${controller.employeeMessageValue.value.toString() ?? 0}",
                                            controller
                                                .userDataProvider
                                                .getEscalationListValues!
                                                .messages
                                                .toString(),
                                            style: GoogleFonts.poppins(
                                                color: Colors.black,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                            // "${controller.respondMessageValue.value.toString() ?? 0}",
                                            controller
                                                .userDataProvider
                                                .getEscalationListValues!
                                                .respondMessage
