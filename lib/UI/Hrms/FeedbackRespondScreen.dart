...
class FeedbackRespondScreen extends GetView<FeedbackRespondScreenController> {
  const FeedbackRespondScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    FeedbackRespondScreenController controller =
        Get.put(FeedbackRespondScreenController());
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: NetworkImage(
                          ApiUrl.baseUrl +
                              "escalation/" +
                              controller
                                  .userDataProvider.feedbackValues!.profileImage
                                  .toString(),
                        ),
                      ),
                    ),
