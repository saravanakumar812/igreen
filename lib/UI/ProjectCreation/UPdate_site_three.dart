...
import '../../Controller/UpdateSiteThreeController.dart';
import '../../forms/forms.dart';

class UpdateSiteThree extends GetView<UpdateSiteThreeController> {
  const  UpdateSiteThree({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    UpdateSiteThreeController controller = Get.put(UpdateSiteThreeController());
                  ...
                  child: Column(
                    children: [
                      const Padding(
                        ...
                        child: Row(
                          children: [
                            Text("TENDER LOST",style: TextStyle(fontSize: 14,
                      ...
                      const Row(
                        children: [
                          ...
                          Text("Tender Lost",style: TextStyle(
                              color: Color(0xff828282)
                          ),),
                        ],
                      ),
                      ...
                      const Row(
                        children: [
                          Padding(
                            padding: EdgeInsets.only(left:12 ),
                            child: Text("Competitor Name",style: TextStyle(
                                color: Color(0xff828282)
                            ),),
                          ),
                          SizedBox(
                          ...
                          Text("Quote Amount",style: TextStyle(
                              color: Color(0xff828282)
                          ),),
                        ],
                      ),
                    ...
                    children: [
                      const Padding(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: Text("SD DATE WITH AMOUNT/ BANK GAURANTEE/BILL DEDUCTION",style: TextStyle(fontSize: 14,
                                  fontWeight: FontWeight.w400,
                                  color: Color(0xff272727)),),
                            )
                          ],
                  ...
                  child: Column(
                    children: [
                      const Padding(
                        ...
                        child: Row(
                          children: [
                            Text("BOQ",style: TextStyle(fontSize: 14,
                                fontWeight: FontWeight.w400,
                                color: Color(0xff272727)),)
                          ],
                        ),
                  ...
                  child: Column(
                    children: [
                      const Padding(
                        ...
                        child: Row(
                          children: [
                            Text("Project Details",style: TextStyle(fontSize: 14,
                                fontWeight: FontWeight.w400,
                                color: Color(0xff272727)),)
                          ],
                        ),
