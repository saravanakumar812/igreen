...
class OnDutyEntryScreen extends GetView<OnDutyEntryScreenController> {
  const OnDutyEntryScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    OnDutyEntryScreenController controller =
        Get.put(OnDutyEntryScreenController());
                ...
                child: SingleChildScrollView(
                  child: Column(children: [
                    ...
                    TextInput(
                      ...
                      height: 100,
                      isReadOnly: true,
                      label: "Starting Date And Hours",
                      onTextChange: (text) {
                        controller.startDateAndTimeController.text = text;
                    ...
                    TextInput(
                        ...
                        controller: controller.closeDateAndTimeController,
                        height: 100,
                        isReadOnly: true,
                        label: "Closing Date And Hours",
                        onTextChange: (text) {
                          controller.closeDateAndTimeController.text = text;
                          controller.popUpValue.value = true;
                        },
                        textInputType: TextInputType.phone,
                        textColor: Color(0xCC252525),
  ...
  if (picked != null) {
    ...
    if (selectedTime != null) {
      ...
      controller.startDateAndTimeController.text =
          DateFormat('yyyy-MM-dd HH:mm:ss').format(controller.selectedStartDate!);
    }
  }
}
