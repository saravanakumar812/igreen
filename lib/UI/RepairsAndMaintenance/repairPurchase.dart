...
class RepairPurchaseEntryScreen extends GetView<RepairPurchaseEntryController> {
  const RepairPurchaseEntryScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    RepairPurchaseEntryController controller = Get.put(RepairPurchaseEntryController());
