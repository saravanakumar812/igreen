...
class SummaryScreen extends GetView<SummaryScreenController> {
      ...
      child: Scaffold(
        ...
        body: Obx(
          () => controller.isLoading.value
              ...
              : controller.getSummaryListData!.isNotEmpty || controller.getSummaryCategoryAmount!.isNotEmpty
                      ...
                      child: RefreshIndicator(
                        ...
                        child: Column(
                          children: [
                            ...
                            controller.getSummaryCategoryAmount!.isEmpty ?Container() :
                            Wrap(
                              children: List.generate(
                                  controller.getSummaryCategoryAmount.length,
                                  (index) => summaryData(context, index)),
                            ),
  ...
  Widget summaryData(BuildContext context, int index) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
    var model = controller.getSummaryCategoryAmount[index];
    return (Column(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        Container(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    controller.getSummaryCategoryAmount[index].mainCategory ?? "",
                    style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.w600,
                        color: Colors.black),
                  ...
                  Container(
                    width: MediaQuery.of(context).size.width * 0.5,
                    child: Text(
                      controller.getSummaryCategoryAmount[index].totalExpenseAmount
                          .toString(),
                      maxLines: 2,
                      style: TextStyle(
                        fontSize: 12,
