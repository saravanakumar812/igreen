...
class UtilizationEntryScreen extends GetView<UtilizationEntryController> {
  const UtilizationEntryScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    UtilizationEntryController controller =
        Get.put(UtilizationEntryController());
                    ...
                    children: [
                      ...
                      Text(
                        controller.userDataProvider.getCurrentStatus
                                    .toString() ==
                                'Edit'
                            ? "Update Utilization Expense"
                            : "Add Utilization Expense",
                        style: TextStyle(
                            fontSize: 15,
                ...
                child: SingleChildScrollView(
                  child: Column(children: [
                    ...
                    TextInput(
                      ...
                      obscureText: true,
                      // isReadOnly: true,
                      onTextChange: (utilization) {
                        controller.popUpValue.value = true;
                        if (utilization.length >= 2) {
                          controller.subCategory1Call(utilization);
                        } else {
                          return;
                        }
                      },
                                          ...
                                          TextInput(
                                            onPressed: () {
                                              ...
                                              controller.commonVisible.value =
                                                  false;
                                              controller.isQuantityOpen.value =
                                                  false;
                                              controller.isOthersOpen.value =
                                                  false;
                                              if (controller
                                        ...
                                        if (controller.userDataProvider.getCurrentStatus == "Edit" ||
                                          ...
                                          for (int i = 0; i < controller.subCategory1.length; i++) {
                                            if (controller.subCategory1[i].sub1CategoryName ==
                                                controller.userDataProvider.getUtilizationData!.category2) {
                    ...
                    Obx(
                      () => Visibility(
                        visible: controller.isOthersOpen.value,
                        child: Container(
                          width: (width),
                          child: TextInput(
                    ...
                    Obx(
                      () => Visibility(
                        visible: controller.isQuantityOpen.value,
                        child: Container(
                          width: (width),
                          child: TextInput(
                            ...
                            onPressed: () {
                              if (controller.userDataProvider.getCurrentStatus
                                ...
                                if (controller.popUpValue.value == false) {
                                  ...
                                  print('popUpValueTrue');
                                  controller.insertUtilizationApi();
                                }
                              } else {
                                controller.insertUtilizationApi();
                              }
